    ...
    >
      <Fade in={props.open}>
        <div className={classes.paper}>
          ...
          <Grid item xs={12} sm={12}>
            <FormControl className={classes.formControl}>
              <InputLabel id="select-label">Lecurer</InputLabel>
              <Select
                labelId="select-label"
                id="simple-select"
                fullWidth
              ...
              >
                <MenuItem value={'adweshshaddie@gmail.com'}>
                  Dr. Adwera
                </MenuItem>
                <MenuItem value={'adwera.shadrack@gmail.com'}>
                  Mr. Shadrack Adwera
                </MenuItem>
                <MenuItem value={'bazubigman0@gmail.com'}>Sir Bazu</MenuItem>
              </Select>
            </FormControl>
          </Grid>
          <br />
